...
namespace PWS
{
    ...
    public static class Seeds
    {
        ...
        public static SeedData GenerateSeedData(BlockType typeOfSeed, Vector2i pos, bool isMixed = false)
        {
            ...
            //int blockComplexity = ConfigData.BlockComplexity[(int)typeOfSeed];
            int blockComplexity = DataManagement.ItemDB.GetByID((int)typeOfSeed).complexity;

            int growthDurationSeconds = SeedData.CalculateGrowthTimeInSeconds(blockComplexity, typeOfSeed);
