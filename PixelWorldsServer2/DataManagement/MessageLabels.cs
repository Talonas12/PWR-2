...
namespace PWS.DataManagement
{
    class MsgLabels
    {
        ...
        public static List<int> allowedFg = new List<int>() { 76, 1396, 329, 3964, 4949, 4946, 4945, 4947, 299, 4948, 4944 };
        public static List<int> illegalFg = new List<int>() { 1, 3 };
        ...
        public struct Ident // Stands for: Identification. Every string value that is used for BsonObject["ID"] = {...} goes here
        {
            ...
            public const string RequestAIEnemySpawns = "rAI";
